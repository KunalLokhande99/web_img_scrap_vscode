# Web_image_scraping using BeautifulSoup and HTML...
...
def index():
    if request.method == 'POST':
                try:
                    ...
                    # code for MongoDB
                    client = pymongo.MongoClient("mongodb+srv://kunallokhandea99:RiyTk1ioj17yK2de@cluster0.kajc9tq.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
